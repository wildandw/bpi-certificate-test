...
<head>
  ...
  <title>Daftar Siswa TOEFL Primary Step 2</title>
  <!-- Bootstrap 5 CSS CDN -->
...
<body>
  <div class="container">
    <div class="table-container">
      <h1 class="text-center">Data Siswa - TOEFL Primary Step 2</h1>
       ...
       <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
          <a href="{{ route('toeflprimarystep2.export') }}" class="btn btn-success me-2">
            <i class="bi bi-file-earmark-spreadsheet"></i> Download Semua Data
          </a>

          <form id="form-delete-all"
                action="{{ route('toeflprimarystep2.destroyall') }}"
                method="POST"
                class="d-inline">
            @csrf
            @method('DELETE')
              ...
              <td>
                ...
                <div class="action-buttons">
                  <button class="btn btn-primary btn-sm"
                      data-preview="{{ route('certificate.showtoeflprimarystep2', $student->id) }}"
                      data-download="{{ route('certificatetoeflprimarystep2.pdf', $student->id) }}"
                  ...
                  <!-- hapus -->
                    <form id="form-delete-{{ $student->id }}"
                        action="{{ route('toeflprimarystep2.destroy', $student->id) }}"
                        method="POST"
                        class="d-inline">
                    @csrf
                    @method('DELETE')
  ...
  <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="editModalLabel">Edit Data Siswa Toefl Primary Step 2</h5>
  ...
  <script>
    function showCertificate(previewUrl, downloadUrl) {
      ...
      document.getElementById('downloadBtn').onclick = function () {
          ...
          link.download = "Sertifikat_toeflprimarystep2.pdf";
