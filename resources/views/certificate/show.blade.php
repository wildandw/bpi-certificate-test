...
<body>
  ...
  <div class="certificate">
      ...
      <div class="right-column">
        ...
        <div class="qrcode-section">
          <div>Scan here for validation</div>
            <div class="qrcode">
              <img src="https://api.qrserver.com/v1/create-qr-code/?size=70x70&data=https://bpi-english-lab.com/validate/certificate/12345" alt="QR Code" />
            </div>
          <div>Valid until: 15/12/24</div>
        </div>
      </div>
    </div>
    ...
    <!-- SCORES -->
    <div class="scores-container">
      <div class="test-date">Test Date: 12 May 2025</div>
      <div class="total-score">
        <div class="label">Total Score</div>
        <div class="value">{{ $certificate->total_score}}</div>
      </div>
