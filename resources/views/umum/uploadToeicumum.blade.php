...
<head>
  ...
  <title>Upload Data Skor TOEIC - Umum</title>
  <!-- Bootstrap 5 CSS CDN -->
...
<body>
  <div class="container">
    <div class="upload-container">
      <h1 class="text-center">TOEIC Raw Score Conversion - <b>Umum</b></h1>
    ...
    @endif
      ...
      <form action="{{ route('scores.importToeicumum') }}" method="POST" enctype="multipart/form-data">
        @csrf
      ...
      {{-- tampilkan jika belum ada conversion rate --}}
        ...
        <div class="mb-3">
            <label for="score_file" class="form-label fw-semibold">TOEIC Scores</label>
