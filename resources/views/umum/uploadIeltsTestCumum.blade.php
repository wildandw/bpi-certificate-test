...
<head>
  ...
  <title>Upload Data Skor Ielts - Umum</title>
  <!-- Bootstrap 5 CSS CDN -->
...
<body>
  <div class="container">
    <div class="upload-container">
      <h1 class="text-center">IELTS Test Raw Score Conversion - <b>Umum</b></h1>
    ...
    @endif
      ...
      <form action="{{ route('scores.importIeltsTestCumum') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="mb-3">
            <label for="score_file" class="form-label fw-semibold">IELTS Scores</label>
