...
<head>
  ...
  <title>Upload Data Skor TOEFL Junior - Umum</title>
  <!-- Bootstrap 5 CSS CDN -->
...
<body>
  <div class="container">
    <div class="upload-container">
      <h1 class="text-center">TOEFL Junior Raw Score Conversion - <b>Umum</b></h1>
    ...
    @endif
      ...
      <form action="{{ route('scores.importJuniorumum') }}" method="POST" enctype="multipart/form-data">
        @csrf
