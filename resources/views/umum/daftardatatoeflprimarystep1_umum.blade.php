...
<body>
  <div class="container">
    <div class="table-container">
      <h1 class="text-center">Data TOEFL Primary Step 1 - Umum</h1>
     ...
     <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
          <a href="{{ route('toeflprimarystep1.export') }}" class="btn btn-success me-2">
            <i class="bi bi-file-earmark-spreadsheet"></i> Download Semua Data
          </a>

          <form id="form-delete-all"
                action="{{ route('toeflprimarystep1.destroyallumum') }}"
                method="POST"
                class="d-inline">
            @csrf
            @method('DELETE')
              ...
              <td>
               ...
               <div class="action-buttons">
                  <button class="btn btn-primary btn-sm"
                      data-preview="{{ route('certificate.showtoeflprimarystep1umum', $student->id) }}"
                      data-download="{{ route('certificatetoeflprimarystep1.pdfumum', $student->id) }}"
                  ...
                  <!-- hapus -->
                    <form id="form-delete-{{ $student->id }}"
                        action="{{ route('toeflprimarystep1.destroyumum', $student->id) }}"
                        method="POST"
                        class="d-inline">
                    @csrf
                    @method('DELETE')
  ...
  <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="editModalLabel">Edit Data Siswa Toefl Primary Step 1</h5>
...
editModal.addEventListener('show.bs.modal', function (event) {
  ...
  form.action = '/toeflprimarystep1/' + id;
  ...
  ['name','class','email','gender',
   ...
   'writing_score','no_sertif','valid_date'
