...
<head>
  ...
  <title>Daftar Siswa Toeic Test Prediction C</title>
  <!-- Bootstrap 5 CSS CDN -->
...
<body>
  <div class="container">
    <div class="table-container">
      <h1 class="text-center">Data Siswa - TOEIC</h1>
              ...
              <td>
                ...
                <div class="action-buttons">
                  <button class="btn btn-primary btn-sm"
                      data-preview="{{ route('certificate.showtoeic', $student->id) }}"
                      data-download="{{ route('certificatetoeic.pdf', $student->id) }}"
                  ...
                  <!-- hapus -->
                    <form id="form-delete-{{ $student->id }}"
                        action="{{ route('toeic.destroy', $student->id) }}"
                        method="POST"
                        class="d-inline">
                    @csrf
                    @method('DELETE')
